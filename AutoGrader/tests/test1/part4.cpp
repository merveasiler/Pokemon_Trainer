...
// g++ -ansi -pedantic submission/pokemon.cpp submission/region.cpp tests/test1/part4.cpp -o tests/test1/part4
...
int tester() {
	...
	/*              PART 4              */
	/* ******************************** */
	int cells[5][3] = {{1, 0, 1}, {5, 0, 3}, {4, 1, 3}, {4, 3, 4}, {2, 1, 1}};
	string p_names[5] = {"p44", "p10", "p19", "p47", "p29"};
