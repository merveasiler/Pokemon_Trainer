...
// g++ -ansi -pedantic submission/pokemon.cpp submission/region.cpp tests/test7/exp1.cpp -o tests/test7/exp1
// valgrind --tool=massif --massif-out-file=tests/test7/massif_output_exp1.txt ./tests/test7/exp1
...
int tester() {
	...
	r.placePokemon(Pokemon("p1", "water", -1), 4, 4, 4);
