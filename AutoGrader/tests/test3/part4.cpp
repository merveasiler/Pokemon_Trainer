...
// g++ -ansi -pedantic submission/pokemon.cpp submission/region.cpp tests/test3/part4.cpp -o tests/test3/part4
...
int tester() {
	...
	/*              PART 4              */
	/* ******************************** */
	int cells[5][3] = {{39, 70, 0}, {34, 124, 0}, {10, 91, 0}, {42, 12, 0}, {40, 34, 0}};
	string p_names[5] = {"p0", "p222", "p444", "p666", "p888"};

	for (i=0, success=0; i<5; i++) {
		try {	// get pokemons
